...
export function useComplaintFindMany<
...
>(
  ...
  const roq = useRoqClient();
  const key = JSON.stringify(['useComplaintFindMany', args || {}]);
  return useSWR<R, Error>(
    key,
    async () => {
      const result = await roq.complaint.findMany(args, options);
      return result as R;
    },
    {
      ...swrOptions,
...
export function useComplaintCount<T extends Prisma.complaintCountArgs, R extends number>(
  args?: Prisma.SelectSubset<T, Prisma.complaintCountArgs>,
  options?: RequestOptions,
  swrOptions?: SWRRequestOptions<R>,
) {
  const roq = useRoqClient();
  const key = JSON.stringify(['useComplaintCount', args || {}]);
  return useSWR<R, Error>(
    key,
    async () => {
      const result = await roq.complaint.count(args, options);
      return result as R;
    },
    {
      ...swrOptions,
...
export function useComplaintFindManyWithCount<
  T extends Prisma.complaintFindManyArgs,
  R extends { data: GetFindResult<Prisma.$complaintPayload<DefaultArgs>, T>[]; count: number },
>(
  args?: Prisma.SelectSubset<T, Prisma.complaintFindManyArgs>,
  options?: RequestOptions,
  swrOptions?: SWRRequestOptions<R>,
  ...
  const roq = useRoqClient();
  const key = JSON.stringify(['useComplaintFindManyWithCount', args || {}]);
  return useSWR<R, Error>(
    key,
    async () => {
      const result = await roq.complaint.findManyWithCount(args, options);
      return result as R;
    },
    {
      ...swrOptions,
...
export function useComplaintFindFirst<
...
>(
  ...
  const roq = useRoqClient();
  const key = JSON.stringify(['useComplaintFindFirst', args || {}]);
  return useSWR<R, Error>(
    key,
    async () => {
      const result = await roq.complaint.findFirst(args, options);
      return result as R;
    },
    {
      ...swrOptions,

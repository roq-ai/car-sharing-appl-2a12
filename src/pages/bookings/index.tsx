...
export function BookingListPage(props: BookingListPageProps) {
  ...
  const queryParams = useMemo(
    () =>
      convertQueryToPrismaUtil(
        {
          relations: ['user', 'car', 'complaint.count', 'review.count'],
  ...
  const columns: ColumnType[] = [
    ...
    hasAccess('car', AccessOperationEnum.READ, AccessServiceEnum.PROJECT)
      ...
      : null,
    hasAccess('complaint', AccessOperationEnum.READ, AccessServiceEnum.PROJECT)
      ? {
          id: 'complaint',
          header: 'Complaint',
          accessorKey: 'complaint',
          cell: ({ row: { original: record } }: any) => record?._count?.complaint,
        }
      : null,

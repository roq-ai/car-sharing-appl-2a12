  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Experience the future of travel with Car Sharing Application - where convenience meets sustainability for a seamless journey."
        />
      </Head>
      <ConfigureCodeBanner
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Experience the future of travel with Car Sharing Application - where convenience meets sustainability for a seamless journey.`}
            </Text>
            <Box
            ...
            >
              <Stack direction={{ md: 'row', base: 'column' }} spacing="1.5rem">
                <Card
                  userTypeName="Customer Service Representative"

...
import { useComplaintFindFirst, useRoqClient } from 'lib/roq';
...
function ComplaintViewPage() {
  ...
  const queryParams = useMemo<{ include: { user: boolean; booking: boolean } }>(
    () =>
  ...
  const { data, error, isLoading } = useComplaintFindFirst(queryParams, {}, { disabled: !id });

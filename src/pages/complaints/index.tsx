...
import { useRoqClient, useComplaintFindManyWithCount } from 'lib/roq';
...
export function ComplaintListPage(props: ComplaintListPageProps) {
  ...
  const { data, error, isLoading, mutate } = useComplaintFindManyWithCount({
  ...
  const handleDelete = async (id: string) => {
    setDeleteError(null);
    try {
      await roqClient.complaint.delete({ where: { id } });
      await mutate();
    } catch (error) {

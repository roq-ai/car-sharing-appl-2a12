...
import { useComplaintCount, useCarCount, useReviewCount } from 'lib/roq';

import { ComplaintListPage as ShowCaseList } from 'pages/complaints';

function DashboardPage() {
  const { session } = useSession();

  const complaintStat = useComplaintCount();
          ...
          <Stack direction="column" spacing={8} flex={{ base: 1, md: 7 }}>
            ...
            <Box>
              <Flex mb={4} justifyContent={'space-between'}>
                ...
                <NextLink href={`complaints`} passHref legacyBehavior>
                  <Button
